...
export function SurveyModal({
  ...
  return <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-x-0 bottom-0 top-0 flex items-end justify-center pt-20">
        <div className="relative bg-white w-full max-w-[428px] h-full rounded-t-3xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom duration-300">
          {/* Close Button */}
